...
export default function Kendaraan({ kendaraan, pegawaiOptions }) {
    ...
    const jenisBadge = (jenis) => {
        ...
        return (
            <span className={`inline-block rounded-full px-3 py-1 text-xs font-medium ${isRoda2 ? 'bg-blue-50 text-blue-700' : 'bg-primary-pale/30 dark:bg-primary-dark/30 text-emerald-700 dark:text-emerald-300'}`}>
                {jenis || '-'}
            </span>
        );
    };
            ...
            actions={
                <>
                    <button
                        ...
                        className="rounded-2xl border border-gray-300 px-4 py-3 text-sm font-medium text-gray-700 dark:text-gray-200"
                    >
                ...
                <div>
                    <div className="mb-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-[0.8fr_0.8fr_0.8fr_1.6fr]">
                        <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700 p-5">
                            <p className="text-sm text-gray-500 dark:text-gray-400">Total Kendaraan</p>
                            <p className="mt-2 text-3xl font-semibold text-gray-900 dark:text-gray-100">
                                {kendaraan.length}
                            </p>
                        </div>
                        <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700 p-5">
                            <p className="text-sm text-gray-500 dark:text-gray-400">Roda 2</p>
                            <p className="mt-2 text-3xl font-semibold text-gray-900 dark:text-gray-100">
                                {kendaraan.filter((item) => item.jenis_kendaraan === 'roda_2').length}
                            </p>
                        </div>
                        <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700 p-5">
                            <p className="text-sm text-gray-500 dark:text-gray-400">Roda 4</p>
                            <p className="mt-2 text-3xl font-semibold text-gray-900 dark:text-gray-100">
                                {kendaraan.filter((item) => item.jenis_kendaraan === 'roda_4').length}
                            </p>
                        </div>
                        <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5 sm:col-span-2 lg:col-span-1">
                            <input
                                className="w-full rounded-2xl border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 px-4 py-3 text-sm"
                                ...
                                >
                                    ...
                                    <dl className="mt-4 grid gap-3 text-sm text-gray-600 sm:grid-cols-2">
                                        <div>
                                            ...
                                            <dd className="mt-1 font-medium text-gray-900 dark:text-gray-100 truncate">
                                                {item.kode_kendaraan || '-'}
                                            </dd>
                                        </div>
                                        <div>
                                    ...
                                    <div className="mt-5 flex gap-2">
                                        <button
                                            ...
                                            className="flex-1 rounded-2xl border border-gray-300 dark:border-gray-600 px-4 py-3 text-center text-sm font-medium text-gray-700 dark:text-gray-200 dark:text-gray-200"
                                        >
                                            Edit
                                        </button>
                                        <button
