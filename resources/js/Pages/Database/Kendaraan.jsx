    ...
    return (
        ...
        >
            ...
            <div className="mb-6 space-y-6">
                ...
                >
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                        <div className="md:col-span-2">
                            ...
                            <InputError
                                className="mt-2"
                                message={form.errors.kode_kendaraan}
                            />
                        </div>
                        <div>
                            <input
                            ...
                            <InputError
                                className="mt-2"
                                message={form.errors.nomor_polisi}
                            />
                        </div>
                        <div>
                            <input
                        ...
                        <div>
                            ...
                            <InputError
                                className="mt-2"
                                message={form.errors.jenis_bbm_default}
                            />
                        </div>
                        <div>
                            <select
                ...
                <div>
                    <div className="mb-4 grid gap-4 lg:grid-cols-[0.8fr_0.8fr_0.8fr_1.6fr]">
                                ...
                                {filteredKendaraan.length ? (
                                    filteredKendaraan.map((item) => (
                                        <tr key={item.id}>
                                            ...
                                            <td className="px-5 py-4 uppercase text-stone-600">
